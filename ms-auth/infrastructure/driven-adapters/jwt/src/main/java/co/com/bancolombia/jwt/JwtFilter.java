...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            System.out.println(e); // TODO: Revisar tema de manejo de excepciones y crear el web sec config
            throw new GeneralException("Errorcito tímido", HttpStatusCode.BAD_REQUEST);
        }
